...
void testPrimitiveOperations() {
    ...
    eecsPQ2.push(100);
    eecsPQ2.push(200);
    assert(eecsPQ2.top() == 200);
    eecsPQ2.pop();
    eecsPQ2.pop();
    eecsPQ2.push(20);
    eecsPQ2.push(14);
    assert(eecsPQ2.top() == 20);
    eecsPQ2.pop();
    eecsPQ2.pop();
    eecsPQ2.push(20);
    eecsPQ2.push(14);
...
void testPairing() {
...

    {
        ...
        pairing2.push(9);
        pairing2.push(3);
        assert(pairing2.top()==9);
        pairing2.pop();
        assert(pairing2.top()==3);
        ...
        std::vector<int> d {3,4,5,1,11};
        PairingPQ<int> mytest {d.begin(), d.end()};
        PairingPQ<int> mytest2 {mytest};
        assert(mytest2.size()==mytest.size());
        //Eecs281PQ<int>& mt1 = mytest;
        
       // Eecs281PQ<int>& mt2 = mytest2;
        
        //assert(mt2.size()==3);
        //assert(mt2.top()==4);
        //mytest.push(1);
         PairingPQ<int> testing {};
         testing.push(10);
         testing.push(2);
         testing.push(3);

        PairingPQ<int>::Node* n = testing.addNode(8);
       // mytest.addNode(6);

      //  mytest.push(8);
        testing.updateElt(n,15);
        assert(testing.top()==15);
